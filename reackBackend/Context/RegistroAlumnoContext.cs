...
namespace reackBackend.Context;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=MADARA\\SQLEXPRESS; Initial Catalog=registroAlumno;User ID=Jonathan;Password = 123456; Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83F7EB5137C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83FC6657D45");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83F4BA30701");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F1B1D1F62");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC788574AC3");
